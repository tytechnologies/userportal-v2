<template>
  <div>
    <div class="flex w-full">
      <div class="flex-col flex-1 w-full mb-8">
        <div class="flex mt-1 mb-6">
          <!-- Search -->
          <div
            class="flex flex-1 h-12 px-3 py-2 bg-card border border-white rounded-l hi-search focus-within:border-blue"
          >
